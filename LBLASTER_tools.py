...
def main():
    ...
    print(colored(text2art ("LBLASTER Tools"), 'red'))
    print(colored('Created By LBLASTER\n\n'.center(60),'cyan'))
    print("\n\n")
...
def contact():
        ...
        print ("\033[1;34m---------------------LBLASTER---------------------")
        print ("\033[1;32mGithub: LBLASTER\n\nDiscord: _lblaster_")
        print ("\033[1;34m------------------------------------------------")
        print ("\n\n")
        print ("\033[1;34m----------------------LVL-----------------------")
        print ("\033[1;34mGithub: LVB\n\nDiscord:lysandrevb")
        print ("\033[1;34m------------------------------------------------")
        input("Press Enter for back to the menu ...")
        os.system('cls' if os.name == 'nt' else 'clear')
main()
